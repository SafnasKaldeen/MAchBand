...
export default function EmbossedPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Contact CTA */}
      <section className="bg-amber-600 py-16 px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-white text-amber-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
